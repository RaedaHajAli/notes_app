...
class _AppServiceClient implements AppServiceClient {
  _AppServiceClient(
    ...
    baseUrl ??= 'http://192.168.1.139:8012/noteapp/';
  }
  ...
  @override
  Future<GetNotesResponse> view(int userId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'user_id': userId};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GetNotesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GetNotesResponse.fromJson(_result.data!);
    return value;
  }
